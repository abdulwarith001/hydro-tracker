...
const Profile = () => {
  ...
  const [formValues, setFormValues] = useState({
    totalGoals: String(profile?.totalGoals),
    containerSize: String(profile?.containerSize),
    wake: profile?.wake,
    sleep: profile?.sleep,
  });
    ...
    <SafeAreaView className="px-4 bg-white flex-1">
      <ScrollView showsVerticalScrollIndicator={false}>
        <View className="items-start mt-2">
          <Text className="font-poppins-semibold text-3xl">My profile</Text>
        </View>
        ...
        <View className="mt-6 space-y-4">
          <CustomInput
            ...
            onChangeText={(val) =>
              setFormValues({ ...formValues, totalGoals: val })
            }
          />
          ...
          <CustomSelect
            ...
            onSelectionChange={(val) =>
              setFormValues({ ...formValues, containerSize: val.value })
            }
            options={[
          ...
          <CustomSelect
            ...
            onSelectionChange={(val) =>
              setFormValues({ ...formValues, wake: val.value })
            }
            options={[
          ...
          <CustomSelect
            ...
            onSelectionChange={(val) =>
              setFormValues({ ...formValues, sleep: val.value })
            }
            options={[
